...
jsPsych.plugins['image-slider-response'] = (function() {
  ...
  plugin.trial = function(display_element, trial) {
    ...
    html += '&nbsp;&nbsp;&nbsp;&nbsp;'; //add whitespace between buttons
    html += '<button id="jspsych-image-slider-response-skip" class="jspsych-btn">Skip This Face</button>'; // CUSTOM SKIP BUTTON ADDED
    ...
    // CUSTOM: If subjects skip rating
